...
/*
 * ORIGINAL AUTHOR IS ROB CAMICK,
 * THIS IS A CUSTOMIZED VARIATION OF HIS ORIGINAL TextLineNumber CLASS
 * EDITIED AND CUSTOMIZED BY JARED MASSA
...
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
	...
	public TextLineNumber (JTextComponent component, Font font, Color currentLineColor, Color defaultColor, Color backgroundColor) {
		//THIS PUBLIC CONSTRUCTOR WAS MADE BY JARED MASSA, EVERYTHING ELSE WAS MADE BY ROB CAMICK
		this.component = component;
		setFont(font);
		setBorderGap(5);
		setCurrentLineForeground(currentLineColor);
		this.defaultLineColor = defaultColor;
